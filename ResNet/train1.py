...
model_checkpoint = ModelCheckpoint(filepath='./new_models/mobileNet_checkpoints.h5', verbose=1, save_best_only=True, monitor='val_acc')
...
with open("./new_models/mobileNet_json.json", "w") as json_file:
    json_file.write(model_json)
mobileNet_model.save_weights("./new_models/mobileNet_weights.h5")
mobileNet_model.save("./new_models/mobileNet_model.h5")
